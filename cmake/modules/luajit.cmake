...
elseif(NOT USE_BUNDLED_LUAJIT)
	...
	if(NOT TARGET luajit)
		...
		if(NOT WIN32)
			set(LUAJIT_BUILD_FLAGS "")
			if(ENABLE_PIC)
				set(LUAJIT_BUILD_FLAGS "XCFLAGS=-fPIC")
			endif()
			...
			if("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "ppc64le")
				ExternalProject_Add(luajit
					...
					GIT_TAG "2.1.2"
					CONFIGURE_COMMAND ""
                    BUILD_COMMAND ${CMAKE_MAKE_PROGRAM} ${LUAJIT_BUILD_FLAGS}
					BUILD_IN_SOURCE 1
			...
			elseif(APPLE)
				ExternalProject_Add(luajit
					...
					CONFIGURE_COMMAND ""
					BUILD_COMMAND make MACOSX_DEPLOYMENT_TARGET=10.14 ${LUAJIT_BUILD_FLAGS}
					BUILD_IN_SOURCE 1
					BUILD_BYPRODUCTS ${LUAJIT_LIB}
					INSTALL_COMMAND "")
			else()
